...
function CenterLabel({ viewBox, label, fontSize = '28px' }: { viewBox?: any; label: string; fontSize?: string }) {
    const { cx, cy } = viewBox ?? {};
    return (
        <text
            x={cx}
                    ...
                    <PieChart className="[&_.recharts-layer:focus]:outline-none [&_.recharts-sector:focus]:outline-none dark:[&_.recharts-text.recharts-label]:first-of-type:fill-white">
                        ...
                        >
                            <Label
                                width={30}
                                position="center"
                                content={<CenterLabel label={displayCenter} fontSize={sizeConfig.centerFontSize} />}
                            />
                        </Pie>
